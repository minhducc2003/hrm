...
mysqli_set_charset($Myconnection, 'utf8');
  ...
  if ($totalRows_RCNguoidung<>0)
  {
    ...
    $url = "index.php?require=code_thong_ke.php&title=Thống kê";
    location($url);
    exit;
  }
  else{
...
<form class="form-3" action="doi_user.php" method="post">
    <p class="clearfix">
        <label for="login">Username</label>
        <input type="text" name="ten_dang_nhap" id="login" placeholder="Tài khoản">
    </p>
    <p class="clearfix">
        <label for="password">Password</label>
        <input type="password" name="mat_khau" id="password" placeholder="Mật khẩu">
    </p>
    <p class="clearfix">
